      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div className="hidden md:block">
            <a href="#contact" className="bg-slate-900 text-white px-5 py-2.5 rounded-full font-medium hover:bg-slate-800 transition-colors">
              Get Started
            </a>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white border-b border-slate-100 shadow-lg p-4 flex flex-col gap-4">
             ...
             <a href="#contact" onClick={() => setIsMobileMenuOpen(false)} className="bg-brand-600 text-white text-center py-3 rounded-lg font-medium">
               Order Now
             </a>
          </div>
        )}
